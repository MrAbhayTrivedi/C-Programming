...
Alicia has sent a document to her friend Teodora as a string of characters, i.e. represented by char* not char****. Help her convert the document to  form by completing the following functions:
...
1 The first line contains k:

The next line contains an integer , the number of sentences in the  kth paragraph.
